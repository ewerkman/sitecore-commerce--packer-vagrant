#Requires -Version 3
param(
	[string]$SiteName = "sc9.sc",
	[string]$SiteHostHeaderName = "sxa.storefront.com",
	[string]$SqlDbPrefix = "sc9",
	[string]$CommerceSearchProvider = "SOLR",
	[string]$IdentityServerSiteName = "sc9.IdentityServer"
)
...
$params = @{
		...
		XConnectInstallDir                          = "c:\inetpub\wwwroot\sc9.xconnect"
		...
		CommerceEngineCertificateName               = "sitecore.commerce.cer"
		...
		SXAModuleFullPath                           = Resolve-Path -Path "..\Sitecore Experience Accelerator 1.8*.zip"
		SXACommerceModuleFullPath                   = Resolve-Path -Path "..\Sitecore Commerce Experience Accelerator 2.0.161.zip"
...
# MTkwMjA4MTUyMzI4WjAjBgkqhkiG9w0BCQQxFgQUyZgW2pOKhF8Af8ug1KPs92So
# 6b4wDQYJKoZIhvcNAQEBBQAEggEAdnoUdzevNxHVarowidnOleBFcHlNRNrr8LOj
# jqnEhbcTKOAgBkdO2XF16JlUfkdS9r9V8fMHYNGg5k14tBUIRSyNwzMa7CaSK782
# 49zEuhZbgJHLT9cUEB5fJDetheNx8bIjlMsZ6ERx2lP+u8lnnIHJbW1oE4jSn0Pa
# 1AltQdl+HW+I+7Mi1RVHSrdwp9LR4EEs/xL45BhdXwI/mrOW6rqwDfgrehEicc1A
# RLSd7rgw2or/gdvTIw0ILoDsjHG+LXsfgOEz5rJbe9BRHy+tuMMNyj20LYu0GH6c
# AQP/eCuYrVq3jep/Ymb6eqL26IWAPtjjPMNIheuWJZQogSokdw==
